...
DATABASES = {
    "default": {
        "ENGINE": DB_ENGINE,
        "NAME": os.getenv("DB_NAME", "yellowpages"),
        "USER": os.getenv("DB_USER", "yellowpages"),
        "PASSWORD": os.getenv("DB_PASSWORD", "yellowpages"),
...
# For production, switch to smtp and fill in credentials via .env
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@yellowpages.local")
