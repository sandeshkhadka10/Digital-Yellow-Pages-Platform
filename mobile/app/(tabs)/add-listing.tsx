    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toast.show({
                ...
                duration: 3000,
                render: ({ id }) => (
                    <Toast nativeID={id} action="success" className="px-3 py-2">
                        <ToastTitle size="md">Listing published</ToastTitle>
                        <ToastDescription size="xs">Your business is now live.</ToastDescription>
                    </Toast>
                ),
            });
            resetFormState();
